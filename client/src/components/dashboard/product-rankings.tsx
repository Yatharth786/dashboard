      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          <p className="font-medium text-sm">
            {productName.replace(/"/g, "").substring(0, 50)}
          </p>
...
export default function ProductRankings({
  ...
  // ✅ FIX: Unique AI prompt per source ensures trigger consistency
  const question =
    showBoth
  ...
  // ✅ FIX: Dynamic `sourceTable` helps backend identify the correct dataset
  ...
  // ✅ FIX: Depend on allProducts.length to re-trigger when data updates
