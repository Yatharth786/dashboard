...
export default function AvoidStockoutsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            <div className="hidden lg:flex items-center space-x-2" ref={dropdownRef}>
              ...
              <div className="relative">
                <button
                  ...
                  className="px-3 py-2 text-sm text-red-600 dark:text-red-500 hover:text-red-700 dark:hover:text-red-400 font-semibold rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-all flex items-center gap-1"
                >
                  Use Cases
                ...
                {activeDropdown === 'Use Cases' && (
                  ...
                  >
                    {navigationMenu["Use Cases"].map((item, i) => (
                      ...
                      >
                        <span className="text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform">
                          {item.icon}
                        </span>
            ...
            <div className="px-4 py-4 space-y-2">
              ...
              <div>
                <button 
                  ...
                  className="flex items-center justify-between w-full px-4 py-2 text-red-600 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg font-semibold"
                >
                  Use Cases
                  ...
                  <div className="ml-4 mt-2 space-y-1">
                    {navigationMenu["Use Cases"].map((item, i) => (
                      <button 
                        key={i} 
                        onClick={() => handleMenuItemClick(item)}
                        className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg"
                      >
                        {item.icon}
                        {item.name}
                      </button>
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 px-4 bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="relative max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-700 dark:text-gray-300">Insydz predicts when you'll run out of stock and alerts you before it's too late — <span className="text-red-700 dark:text-red-400 font-semibold">so you never lose sales to stockouts.</span></p>
              <Button onClick={() => setLocation("/login")} size="lg" className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-bold px-8 py-6 text-lg rounded-full shadow-2xl group">
                👉 Prevent Stockouts Free <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
            </div>
            <div className="bg-white dark:bg-gray-900 border-2 border-red-200 dark:border-red-800 rounded-3xl p-8 shadow-2xl">
              <h3 className="font-bold text-gray-900 dark:text-white mb-4">Inventory Alerts</h3>
              <div className="space-y-4">
                <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-400 dark:border-red-600 rounded-xl p-4 animate-pulse">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">Premium Earbuds - Only 12 units left</p>
                      <p className="text-xs text-red-600 dark:text-red-400 font-semibold mt-1">Will run out in 3 days at current sales rate</p>
                    </div>
                  </div>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-yellow-600 dark:text-yellow-400 font-semibold mt-1">Restock in 7 days</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-black mb-12 text-gray-900 dark:text-white">Why Stockouts <span className="text-red-600 dark:text-red-500">Kill Your Business</span></h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Lost sales & revenue", icon: <TrendingUp className="w-8 h-8" /> },
              { title: "Rankings drop instantly", icon: <AlertCircle className="w-8 h-8" /> },
              { title: "Customers buy from competitors", icon: <Package className="w-8 h-8" /> }
            ].map((p, i) => (
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-black text-center mb-12 text-gray-900 dark:text-white">How Stock Monitoring Works <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">with Insydz</span></h2>
          <div className="grid lg:grid-cols-3 gap-12">
            {[
              { step: "1", title: "Connect Inventory", desc: "Link your Amazon & Flipkart inventory automatically" },
              { step: "2", title: "AI Predicts Stockouts", desc: "We calculate when you'll run out based on sales velocity" },
              ...
              <div key={i} className="bg-white dark:bg-gray-800 border-2 border-red-300 dark:border-red-700 rounded-3xl p-8 text-center shadow-xl">
                <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-black text-white">{s.step}</div>
          ...
          <div className="text-center mt-12">
            <Button onClick={() => setLocation("/login")} size="lg" className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-bold px-12 py-6 rounded-full shadow-2xl">
              👉 Never Miss Sales Again <ChevronRight className="ml-2" />
            </Button>
          </div>
        </div>
      ...
      {/* Final CTA */}
      <section className="py-20 px-4 bg-gradient-to-br from-red-50 to-orange-50 dark:from-gray-900 dark:to-gray-950">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-black mb-6 text-gray-900 dark:text-white">Stop Losing Sales to Stockouts. <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">Stay Ahead.</span></h2>
          <Button onClick={() => setLocation("/login")} size="lg" className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-bold px-12 py-6 rounded-full shadow-2xl">
            👉 Prevent Stockouts Free <ArrowRight className="ml-2" />
          </Button>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button onClick={() => setLocation("/")} className="block text-gray-400 hover:text-red-400 transition-colors text-sm">
                  Home
                </button>
                <button onClick={() => setLocation("/pricing")} className="block text-gray-400 hover:text-red-400 transition-colors text-sm">
                  Pricing
                </button>
                <button onClick={() => setLocation("/login")} className="block text-gray-400 hover:text-red-400 transition-colors text-sm">
                  Login
                </button>
              </div>
            </div>
