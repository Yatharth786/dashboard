...
//     readTime: "8 min read",
//     image: "/api/placeholder/800/450",
//     route: "/resources/expert-blog/amazon-buy-box",
//     featured: true,
//     popular: true
//   },
//   {
...
const articles: Article[] = [
  {
    ...
    excerpt: "Track competitor prices on Amazon.in, Flipkart, and Meesho in real time. Discover how Indian sellers use AI-powered tools to protect margins, win the Buy Box, and outsell rivals — with a complete 2026 playbook.",
  ...
  },
  {
    ...
    readTime: "10 min read",
    image: "/Best_Price_Tracer-blog2_image1.png",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-14">
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-1">
              ...
              <div className="flex space-x-3 mt-6">
                <a title="Facebook" href="https://www.facebook.com/profile.php?id=61586202582209" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
                  <Facebook className="w-4 h-4" />
                </a>
                <a title="Twitter" href="https://x.com/growwithinsydz" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
                  <Twitter className="w-4 h-4" />
                </a>
                <a title="Instagram" href="https://www.instagram.com/growwithinsydz/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
                  <Instagram className="w-4 h-4" />
                </a>
                <a title="LinkedIn" href="https://www.linkedin.com/company/insydz/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
                  <Linkedin className="w-4 h-4" />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i}>
                    <button onClick={() => setLocation(item.route)} className="text-sm text-gray-400 hover:text-white transition-colors text-left">
                      {item.label}
                    </button>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i}>
                    <button onClick={item.action} className="text-sm text-gray-400 hover:text-white transition-colors text-left">
                      {item.label}
                    </button>
                  </li>
                ))}
