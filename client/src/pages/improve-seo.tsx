...
import { 
  ...
  TrendingDown, MessageCircle, Bell, X,
  Flame,
  Presentation
} from "lucide-react";
import { Button } from "@/components/ui/button";
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
                ...
                {activeDropdown === 'Use Cases' && (
                  ...
                  >
                    {navigationMenu["Use Cases"].map((item, i) => (
                      ...
                      >
                        <span className="text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform">
                          {item.icon}
                        </span>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <Button onClick={() => setLocation("/login")} size="lg" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold px-8 py-6 text-lg rounded-full shadow-2xl group">
                👉 Improve Your SEO Free <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
            </div>
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Button onClick={() => setLocation("/login")} size="lg" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold px-12 py-6 rounded-full shadow-2xl">
              👉 Start Ranking Higher Free <ChevronRight className="ml-2" />
            </Button>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                SEO optimization for marketplace sellers
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <button onClick={() => setLocation("/")} className="block text-gray-400 hover:text-green-400 transition-colors text-sm">
                  Home
                </button>
                <button onClick={() => setLocation("/pricing")} className="block text-gray-400 hover:text-green-400 transition-colors text-sm">
                  Pricing
                </button>
                <button onClick={() => setLocation("/login")} className="block text-gray-400 hover:text-green-400 transition-colors text-sm">
                  Login
                </button>
              </div>
            </div>
