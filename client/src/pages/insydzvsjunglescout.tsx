...
//     'Jungle Scout pricing gets expensive for Indian sellers',
//     'Flipkart data is missing completely',
//     'Too many features you may never use',
//     'Dollar pricing adds up quickly with GST'
//   ];

//   const globalToolLimitations = [
//     'Dollar pricing hurts smaller Indian sellers',
//     'No Flipkart coverage at all',
//     'Email alerts often get missed',
//     'Built for US Amazon, not Indian marketplaces'
//   ];

//   const insydzFitReasons = [
//     'Sell on both Amazon + Flipkart',
//     'Want affordable rupee-based pricing',
//     'Prefer instant WhatsApp alerts',
//     'Need actionable insights, not just data'
//   ];

//   const competitorFitReasons = [
//     'You sell exclusively in US/EU markets',
//     'You need advanced Amazon analytics',
//     'You prefer comprehensive data exploration tools'
//   ];

//   const whyIndianSellersExplore = [
//     'More affordable than dollar-priced tools',
//     'Flipkart insights alongside Amazon',
//     'WhatsApp alerts that actually get noticed',
//     'Simpler, more action-focused approach'
//   ];
...
//       reason: 'Better pricing, multi-marketplace, easier to act on',
//       color: 'from-blue-500 to-cyan-500',
//       icon: <TrendingUp className="w-8 h-8" />
//     },
//     {
//       title: 'Global / US-Focused Sellers',
//       recommendation: 'Jungle Scout',
//       reason: 'Strong for international Amazon markets',
...
//       recommendation: 'Insydz',
//       reason: 'Only tool with Amazon + Flipkart coverage',
...
//       answer: 'Insydz is built specifically for Indian sellers and multi-marketplace needs. If you primarily sell in India across Amazon and Flipkart, Insydz offers better value and coverage. However, if you focus exclusively on US/EU Amazon markets, Jungle Scout may still be a better fit.'
//     },
//     {
//       id: 'faq-2',
//       question: 'Why is Insydz cheaper than Jungle Scout?',
//       answer: 'Insydz is priced in rupees and built for the Indian market, which allows us to offer affordable pricing. We focus on clear, actionable insights rather than overwhelming feature sets, keeping costs lower while delivering what Indian sellers actually need.'
//     },
//     {
//       id: 'faq-3',
//       question: 'Does Insydz offer product and keyword research?',
//       answer: 'Yes. Insydz provides keyword tracking, competitor analysis, and product insights tailored to Indian marketplaces including Amazon and Flipkart. Our approach focuses on actionable recommendations rather than raw data overload.'
//     },
//     {
//       id: 'faq-4',
//       question: 'Can I use Insydz and Jungle Scout together?',
//       answer: 'Absolutely. Many sellers run Insydz alongside Jungle Scout to compare value and insights before making a decision. Insydz is designed to coexist — not force a risky switch.'
//     },
//     {
//       id: 'faq-5',
//       question: 'Which tool is better for Indian sellers?',
//       answer: 'For sellers focused on Indian marketplaces (Amazon India, Flipkart) with budget constraints, Insydz is purpose-built for your needs. For sellers targeting US/EU markets exclusively, Jungle Scout may offer more international-focused features.'
//     },
//     {
//       id: 'faq-6',
//       question: 'Is Insydz a cheaper alternative to Jungle Scout for Indian sellers?',
//       answer: 'Insydz is built specifically for Indian pricing sensitivity and offers similar intelligence at a significantly lower cost. It\'s not just cheaper — it\'s designed for how Indian sellers actually work, with features like Flipkart coverage and WhatsApp alerts.'
//     },
//     {
//       id: 'faq-7',
...
//             Why Sellers Compare
//             <br />
//             <span className="text-blue-600">Insydz and Jungle Scout</span>
//           </h2>
...
//                 </div>
//                 <h3 className="text-2xl font-bold text-gray-900">Jungle Scout</h3>
//               </div>
//               <p className="text-gray-700 leading-relaxed text-lg">
//                 Built primarily for <span className="font-bold">US & global Amazon sellers.</span>
//                 <br /><br />
//                 Comprehensive data tools, but assumes higher budgets and Amazon-only focus.
//               </p>
//             </div>
...
//                     <th className="px-6 py-4 text-left text-white font-bold text-lg">Jungle Scout</th>
//                   </tr>
//                 </thead>
//                 <tbody>
...
//               Jungle Scout pricing may look standard globally, but for Indian sellers the real cost adds up due to dollar pricing, GST, and long-term subscriptions.
//             </p>
...
//                   <h3 className="text-xl font-bold text-gray-900">Jungle Scout</h3>
//                 </div>
//                 <p className="text-3xl font-black text-red-600 mb-2">$49–$129/month</p>
//                 <p className="text-2xl font-bold text-gray-700">≈ ₹4,000–₹10,500+/month</p>
//               </div>
...
//       {/* When Jungle Scout May Make More Sense */}
//       <section className="py-20 px-4 bg-gray-50">
//         <div className="max-w-5xl mx-auto">
//           <h2 className="text-4xl lg:text-5xl font-black mb-12 text-center text-gray-900">
//             When Jungle Scout
...
//       {/* Already Using Jungle Scout - SWITCHING & COEXISTENCE */}
//       <section className="py-20 px-4 bg-white">
//         <div className="max-w-5xl mx-auto">
//           <h2 className="text-4xl lg:text-5xl font-black mb-12 text-center text-gray-900">
//             Already Using Jungle Scout?
//             <br />
...
//               Many sellers start with Insydz alongside Jungle Scout to:
//             </p>
...
//                 </div>
//                 <div>
//                   <p className="font-bold text-gray-900 text-lg mb-1">Choose Jungle Scout if:</p>
//                   <p className="text-gray-700 leading-relaxed">
//                     You sell primarily in US/EU markets and need comprehensive Amazon analytics.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//           <h2 className="text-4xl lg:text-5xl font-black mb-12 text-center text-gray-900">
//             Insydz vs Jungle Scout – <span className="text-blue-600">FAQs</span>
//           </h2>
