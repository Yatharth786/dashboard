...
export default function InsydzVsViralLaunchPage() {
  ...
  const comparisonFeatures = [
    ...
    { area: 'Pricing', insydz: '₹999–₹1,999/month', competitor: '$69–$199/month', insydzIcon: <IndianRupee className="w-5 h-5 text-green-600" />, competitorIcon: <DollarSign className="w-5 h-5 text-gray-500" /> },
