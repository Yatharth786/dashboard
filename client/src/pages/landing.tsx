...
//           <div className="flex flex-wrap items-center justify-center gap-8 mt-6">
//           <Button
//             onClick={() => setLocation('/about/contact-us')}
//             size="sm"
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center flex flex-col items-center justify-center space-y-2 mt-20">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg font-medium tracking-wide max-w-2xl">
            Insydz is India's AI-powered ecommerce analytics software — built specifically for Amazon, Flipkart, and Meesho sellers who are tired of guessing and ready to start growing.
          </p><br></br>
          <div className="flex flex-wrap items-center justify-center gap-8 mt-6">
            <Button
              onClick={() => setLocation('/about/contact-us')}
          ...
          <div className="grid grid-cols-3 gap-6 pt-8 text-center">
            <div className="space-y-1">
              <div className="text-3xl font-bold text-purple-600">250,000+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Reviews Analyzed
              </div>
            </div>
          ...
          <div className="pt-12 max-w-2xl">
            <p className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">
              Trusted by 5,000+ Sellers Across Amazon India, Flipkart & Meesho
            </p>
            <p className="text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 border-2 border-blue-200 dark:border-blue-900 hover:shadow-2xl transition-all">
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Amazon India + Flipkart + Meesho in one dashboard</span>
                </li>
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div
              ...
              <h3 className="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Expert Blog</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Cutting-edge strategies for Amazon India, Flipkart, and Meesho sellers — written by practitioners, not theorists
              </p>
              <button className="text-blue-600 dark:text-blue-400 font-semibold hover:underline">
                Explore Articles →
              </button>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                icon: <TrendingUp className="w-10 h-10" />,
                title: "Multi-Platform Support",
                desc: "Amazon India + Flipkart + Meesho, unified in one view — the only platform built for how Indian sellers actually sell",
                color: "from-purple-500 to-purple-600",
                badge: undefined,
              },
            ].map((feature, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-14">
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                India's AI-powered ecommerce analytics software for Amazon, Flipkart & Meesho sellers.
              </p>
              <button
                onClick={handleGetStarted}
                className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-all transform hover:scale-105 shadow-lg"
