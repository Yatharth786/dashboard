...
// import { Link, useLocation } from "wouter";
// import { useToast } from "@/hooks/use-toast";
// import { useAuth } from "@/App"; // <-- Use AuthContext
// import { Button } from "@/components/ui/button";
// import { Input } from "@/components/ui/input";
// import { Label } from "@/components/ui/label";
// import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
...
//   const API_BASE_URL = "http://localhost:8000"; // replace in prod
...
//       // Auto-fill reset dialog email if incorrect password
//       if (error.message?.includes("password")) setResetEmail(formData.email);
//     }
//   };
...
//           <Link href="/">
//             <a className="inline-flex flex-col items-center group">
//               <img src="/logo.png" alt="Insydz Logo" className="w-20 h-20 mb-3" />
//               <h1 className="text-3xl font-bold text-foreground">Insydz</h1>
//             </a>
//           </Link>
//           <p className="text-muted-foreground">Real-time insights from your review data</p>
//         </div>
...
//           <CardContent className="space-y-6">
//             {errorMessage && (
//               <Alert variant="destructive" icon={<AlertCircle />} description={errorMessage} />
//             )}
...
//               <div className="space-y-2">
//                 <Label htmlFor="password">Password</Label>
//                 <Input id="password" type="password" value={formData.password} onChange={handleInputChange("password")} required />
//               </div>

//               <div className="flex items-center justify-between text-sm">
//                 <div className="flex items-center space-x-2">
//                   <Checkbox checked={rememberMe} onCheckedChange={val => setRememberMe(val === true)} />
//                   <Label className="cursor-pointer">Remember me</Label>
//                 </div>
//                 <Button type="button" variant="link" onClick={() => setShowResetDialog(true)}>
//                   Forgot password?
//                 </Button>
//               </div>
...
//             <div className="text-center pt-4 border-t">
//               <p className="text-xs text-muted-foreground">Secure authentication with password validation</p>
//             </div>
//           </CardContent>
//         </Card>

//         <div className="text-center mt-6 text-sm text-muted-foreground">Powered by Insydz</div>
//       </div>
...
//           <DialogHeader>
//             <DialogTitle>Reset Password</DialogTitle>
//             <DialogDescription>Enter your email and new password</DialogDescription>
//           </DialogHeader>
