    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-6xl font-black mb-6">Price Optimization — <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Maximize Profit</span> Without Losing Sales</h1>
          <p className="text-xl text-gray-700 mb-8">AI recommends the perfect price to win Buy Box while protecting your margins.</p>
          <Button onClick={() => setLocation("/login")} size="lg" className="bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold px-12 py-6 rounded-full shadow-2xl">
            👉 Optimize Prices Free <ArrowRight className="ml-2" />
          </Button>
        </div>
      </section>
