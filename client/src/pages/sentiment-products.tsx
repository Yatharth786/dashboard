...
export default function SentimentProductsPage() {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [source, sentiment, currentPage, productsPerPage, categoryFilter, minPriceFilter, maxPriceFilter, minRatingFilter, dateRangeFilter, trendingOnlyFilter, sortByFilter]); // 🆕 Added all filters

  // 🆕 Reset page when sentiment/source/filters change
  useEffect(() => {
    setCurrentPage(1);
  }, [source, sentiment, categoryFilter, minPriceFilter, maxPriceFilter, minRatingFilter, dateRangeFilter, trendingOnlyFilter, sortByFilter]); // 🆕 Added all filters
